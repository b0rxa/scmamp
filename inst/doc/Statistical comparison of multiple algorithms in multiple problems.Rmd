...
* `'Bergmann Hommel'`, for Bergmann Hommel dynamic approach (_Bergmann and Hommel, 1988_), as explained in _Garcia and Herrera, 2008_, page 2680-2682. For computational reasons this option is only available when comparing 9 or less algorithms. In other case, the methdo is changed to `'Shaffer'` and a warning is displayed.

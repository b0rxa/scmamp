...
#' summarizeData (data , group.by = c('size','alpha','beta') , ignore = c(4,5,7) , fun = median)
#' ## group by size. Get the mean and variance
#' summarizeData (data , group.by = 1 , ignore = 2:3 , fun = mean , na.rm = TRUE)
#' summarizeData (data , group.by = 1 , ignore = 2:3 , fun = sd , na.rm = TRUE)
#' 
